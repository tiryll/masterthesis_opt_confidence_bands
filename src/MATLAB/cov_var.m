...
function D = D_matrix(K)
    % Constructs the duplication matrix D for a KxK matrix.
    % This is a placeholder; you should replace it with the actual construction.
    % The size of D should be K^2 x (K*(K+1)/2)
